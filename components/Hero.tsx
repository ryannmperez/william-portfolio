...
export default function Hero() {
  return (
    <div id="home" className="h-screen flex items-center justify-center hero-gradient relative overflow-hidden">
      ...
      <div className="z-20 w-full max-w-[1400px] mx-auto h-full flex items-center">
        <div className="w-full px-8 flex flex-col md:flex-row items-center justify-end md:justify-start gap-8 md:gap-12 lg:gap-16 pb-16 md:pb-0">
          {/* Headshot - Desktop - Aligned to left edge of container */}
          <div className="hidden md:block relative flex-shrink-0 -mt-8">
            <div
